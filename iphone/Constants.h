...
#define IMAGE_API_REQUEST_URL @"http://openhouse.dachev.com/service/image/resize.png?size=%@&location=%@"
#define SEARCH_API_REQUEST_URL @"http://openhouse.dachev.com/~blago/openhouses/service.py/search?offset=%d&records=%d&lat=%f&lng=%f&distance=%f&bdate=%@&edate=%@"
